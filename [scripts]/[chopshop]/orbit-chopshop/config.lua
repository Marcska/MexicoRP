...
Config.Version = "old" -- If you use a newer version of QBCores "qb-core" (around 1 month old) then set to new otherwise set it to old
...
Config.Email = true -- The sent number plate comes to your phone as an e-mail. If you are going to use Orbit UI, make it false.
