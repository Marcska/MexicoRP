...
Config.Webhook = "https://discord.com/api/webhooks/1061656332089958471/i4qo3NuAbnwtcbEKepuGhL9vF6qcaC-7DJiOCeHyuB2tOqsGMLptqEc22PvjwpfKzc2H" -- insert log channel webhook
...
Config.HackerMenu = {
	...
	CctvCamera = {
		...
		level = 3, -- how many levels are required to access
