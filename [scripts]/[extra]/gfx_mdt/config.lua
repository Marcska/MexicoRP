Config = {
    ...
    Framework = "newqb", --esx, oldesx, qb, newqb
    SQLScript = "oxmysql", --ghmattimysql, mysql-async, oxmysql
    discordWebhook = "https://discord.com/api/webhooks/1216400078172979220/MslLAO4X5AsXrxYFtKO59GdRno9gA9aD3Lam982ieawWpyx9jWzKGan6etEOXaBb7ZI1", -- this is for uploading photos to discord
